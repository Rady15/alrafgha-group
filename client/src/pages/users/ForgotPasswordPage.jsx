...
const ForgotPasswordPage = () => {
  ...
  const { t } = useTranslation('auth');
    ...
    const handleSubmit = async (e) => {
        ...
        if (!email) {
            setError(t('auth:forgotPassword.errorEnterEmail'));
            setIsLoading(false);
            return;
        }
        ...
        if (!emailRegex.test(email)) {
            setError(t('auth:forgotPassword.errorValidEmail'));
            setIsLoading(false);
            return;
        }
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-6 animate-fade-in">
                        ...
                        <div className="text-center">
                            ...
                            <h2 className="text-3xl font-display font-bold text-neutral-900 mb-2">
                                 {t('auth:forgotPassword.successTitlePre')} <span className='text-primary-500'>{t('auth:forgotPassword.email')}</span>
                            </h2>
                            <p className="text-neutral-600 text-sm mb-4">
                                {t('auth:forgotPassword.sentResetLinkTo')}
                            </p>
                        ...
                        <div className="bg-linear-to-br from-primary-50 to-secondary-50 border border-primary-200 rounded-xl p-6 space-y-3">
                            ...
                            <p className="text-xs text-primary-700 mt-3">
                                {t('auth:forgotPassword.expireNote')}
                            </p>
                        </div>
            ...
            <div className="max-w-md w-full">
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-6 animate-fade-in">
                    ...
                    <div className="text-center">
                        ...
                        <h2 className="text-3xl font-display font-bold text-neutral-900 mb-2">
                             {t('auth:forgotPassword.titlePre')} <span className='text-primary-500'>{t('auth:forgotPassword.titleEm')}</span>
                        </h2>
                        ...
                        >
                            {isLoading ? (
                                <>
                                    ...
                                    <span>{t('auth:shared.sending')}</span>
                                </>
                            ) : (
                                <>
