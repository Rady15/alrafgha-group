...
const VendorDashboard = () => {
    ...
    const handleDelete = async (vehicleId) => {
        if (!window.confirm(t('vendor.confirmDeleteVehicle'))) {
            return;
        }
    ...
    if (authLoading) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-neutral-50">
                <p className="text-neutral-600 text-lg font-medium">{t('loading.dashboard')}</p>
            </div>
        );
    }
                ...
                <div className="mb-8 sm:mb-12">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        >
                            ...
                            <span className="hidden sm:inline">{t('common:auth.logout')}</span>
                        </button>
                    </div>

                    {/* Dashboard title and vendor info */}
                    <div className="text-center">
                            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">{t('title.vendor')} <span className='text-red-600'>{t('title.dashboard')}</span></h1>
                            <p className="mt-1 md:mt-2 text-base sm:text-lg text-gray-600">{t('subtitle.vendor')}</p>
                    </div>
                </div>
            </div>
                ...
                {activeTab === 'vehicles' && (
                    <>
                        ...
                        <div className="mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                            <h2 className="text-2xl sm:text-3xl font-bold text-neutral-900">{t('vendor.myVehicles')}</h2>
                            <button
                            ...
                            >
                                {showAddForm ? t('common:actions.cancel') : t('vendor.addVehicle')}
                            </button>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 mb-8 animate-fade-in">
                        <h3 className="text-2xl sm:text-3xl text-center font-bold text-neutral-900 p-6">{t('vendor.vehicleRequest')}</h3>
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">{t('form.vehicleName')} <span className='text-red-500'>*</span></label>
                                <input
                                    type="text"
                                    name="name"
                                    value={formData.name}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">{t('form.modelName')} <span className='text-red-500'>*</span></label>
                                <input
                                    type="text"
                                    name="model_name"
                            ...
                            <CustomDropdown
                                label={                                <span>{t('form.type')} <span className='text-red-500'>*</span></span>}
                                options={[
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">{t('form.brand')} <span className='text-red-500'>*</span></label>
                                <input
                                    type="text"
                                    name="brand"
                            ...
                            <div className="md:col-span-2">
                                <label className="block text-sm font-medium text-neutral-700 mb-1">{t('form.location')} <span className='text-red-500'>*</span></label>
                                <input
                                    type="text"
                                    name="location"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">{t('form.registrationNumber')} <span className='text-red-500'>*</span></label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">{t('form.engineNumber')} <span className='text-red-500'>*</span></label>
                                <input
                                    type="text"
                                    name="engine_number"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">{t('form.chassisNumber')} <span className='text-red-500'>*</span></label>
                                <input
                                    type="text"
                                    name="chassis_number"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">{t('form.engineCC')} <span className='text-red-500'>*</span></label>
                                <input
                                    type="number"
                                    name="cc_engine"
                            ...
                            {packageInfo && (
                                <div className="md:col-span-2 bg-blue-50 border border-blue-200 rounded-lg p-4">
                                    <h4 className="font-semibold text-blue-900 mb-2">{t('section.packageDetails')}</h4>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">
                                    RC Document <span className='text-red-500'>*</span> <span className="text-xs text-gray-500">{t('form.maxSize')}</span>
                                </label>
                                <input
                                    type="file"
                                    name="rc_document"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-1">
                                    Insurance Document <span className='text-red-500'>*</span> <span className="text-xs text-gray-500">{t('form.maxSize')}</span>
                                </label>
                                <input
                                    type="file"
                            ...
                            <div className="md:col-span-2">
                                <label className="block text-sm font-medium text-neutral-700 mb-1">
                                    Vehicle Images <span className='text-red-500'>*</span> <span className="text-xs text-gray-500">{t('form.vehicleImagesHint')}</span>
                                </label>
                                <input
                                    type="file"
                                    name="vehicle_images"
                                ...
                                {files.vehicle_images.length > 0 && (
                                    <p className="text-xs text-gray-600 mt-1">{t('vendor.filesSelected', { count: files.vehicle_images.length })}</p>
                                )}
                            </div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                >
                                    {uploading ? t('vendor.submittingRequest') : t('vendor.submitVehicleRequest')}
                                </button>
                            </div>
                        </form>
                        </div>
                        ...
                        {loading ? (
                            <div className="text-center py-8 sm:py-12">
                                ...
                                <p className="mt-4 text-neutral-600 text-sm sm:text-base">{t('vendor.loadingVehicles')}</p>
                            </div>
                        ) : vehicles.length === 0 ? (
                            <div className="text-center py-8 sm:py-12 bg-white rounded-2xl shadow-lg px-4">
                                <p className="text-neutral-600 text-base sm:text-lg">{t('vendor.noVehicles')}</p>
                            </div>
                        ) : (
                                    ...
                                    <div key={vehicle._id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
                                        ...
                                        <div className="p-3 sm:p-4 space-y-2 sm:space-y-3">
                                            <div className="flex justify-between items-center">
                                                <span className="text-xs sm:text-sm text-neutral-600">{t('details.registration')}:</span>
                                                <span className="font-semibold text-neutral-900 text-xs sm:text-sm">{vehicle.registration_number}</span>
                                            </div>

                                            <div className="flex justify-between items-center">
                                                <span className="text-xs sm:text-sm text-neutral-600">{t('table.status')}:</span>
                                                <span className={`px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold ${vehicle.availability_status === 'available' ? 'bg-green-100 text-green-700' :
                                                    ...
                                                    {t('status.' + vehicle.availability_status)}
                                                </span>
                                            </div>
                                            ...
                                            <div className="border-t pt-2 sm:pt-3 mt-2 sm:mt-3">
                                                <div className="grid grid-cols-2 gap-2 text-xs sm:text-sm">
                                                    <div>
                                                        <p className="text-neutral-600">{t('stats.totalDistance')}</p>
                                                        <p className="font-bold text-neutral-900">{vehicle.total_distance_travelled || 0} km</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-neutral-600">{t('stats.totalHours')}</p>
                                                        <p className="font-bold text-neutral-900">{vehicle.total_hours_booked || 0} hrs</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-neutral-600">{t('stats.totalBookings')}</p>
                    ...
                    <>
                        ...
                        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="bg-linear-to-r from-green-500 to-emerald-600 rounded-2xl shadow-lg p-6 text-white">
                                ...
                                <p className="text-white/80 text-sm mt-2">{t(earnings.length === 1 ? 'earnings.completedBooking' : 'earnings.completedBookings', { count: earnings.length })}</p>
                            </div>
                            ...
                            <div className="bg-linear-to-r from-orange-500 to-red-600 rounded-2xl shadow-lg p-6 text-white">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-white/80 text-sm font-medium">{t('stats.currentlyBooked')}</p>
                                ...
                                <p className="text-white/80 text-sm mt-2">{t(vehicles.filter(v => v.availability_status === 'booked').length === 1 ? 'earnings.vehicleOnRent' : 'earnings.vehiclesOnRent', { count: vehicles.filter(v => v.availability_status === 'booked').length })}</p>
                            </div>
                            ...
                            <div className="bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl shadow-lg p-6 text-white">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-white/80 text-sm font-medium">{t('stats.totalListedVehicles')}</p>
                                ...
                                <p className="text-white/80 text-sm mt-2">{t(vehicles.length === 1 ? 'earnings.activeVehicle' : 'earnings.activeVehicles', { count: vehicles.length })}</p>
                            </div>
                        </div>
                        ...
                        {earningsLoading ? (
                            <div className="text-center py-12">
                                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary-600 mx-auto"></div>
                                 <p className="mt-4 text-neutral-600">{t('earnings.loading')}</p>
                            </div>
                        ) : earnings.length === 0 ? (
                            <div className="text-center py-12 bg-white rounded-2xl shadow-lg">
                                 <p className="text-neutral-600 text-lg">{t('earnings.noEarnings')}</p>
                            </div>
                        ) : (
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full" data-testid="earnings-table">
                                        <thead className="bg-linear-to-r from-primary-500 to-secondary-500 text-white">
                                            <tr>
                                                 <th className="px-4 py-3 text-left text-sm font-semibold">{t('table.vehicleInfo')}</th>
                                                 <th className="px-4 py-3 text-left text-sm font-semibold">{t('table.pickupDateTime')}</th>
                                                 <th className="px-4 py-3 text-left text-sm font-semibold">{t('table.returnDateTime')}</th>
                                                 <th className="px-4 py-3 text-left text-sm font-semibold">{t('table.distanceKm')}</th>
                                                 <th className="px-4 py-3 text-left text-sm font-semibold">{t('table.paymentMode')}</th>
                                                 <th className="px-4 py-3 text-left text-sm font-semibold">{t('table.damageCost')}</th>
                                                 <th className="px-4 py-3 text-left text-sm font-semibold">{t('table.totalCost')}</th>
                                            </tr>
                                        </thead>
                                            ...
                                            {earnings.map((earning, index) => (
                                                <tr key={earning._id} className="hover:bg-neutral-50 transition-colors" data-testid={`earning-row-${index}`}>
                                                    <td className="px-4 py-4">
                                                        <div>
                                                            <p className="font-semibold text-neutral-900">{earning.vehicle_id?.name || t('na')}</p>
                                                        ...
                                                        <div>
                                                            <p className="text-sm text-neutral-900">
                                                                    {earning.pickup_details?.actual_pickup_date 
                                                                        ? formatDate(earning.pickup_details.actual_pickup_date)
                                                                    : t('na')}
                                                            </p>
                                                            <p className="text-xs text-neutral-600">
                                                                {earning.pickup_details?.actual_pickup_time || t('na')}
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td className="px-4 py-4">
                                                        <div>
                                                            <p className="text-sm text-neutral-900">
                                                                    {earning.return_details?.actual_return_date 
                                                                        ? formatDate(earning.return_details.actual_return_date)
                                                                    : t('na')}
                                                            </p>
                                                            <p className="text-xs text-neutral-600">
                                                                {earning.return_details?.actual_return_time || t('na')}
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td className="px-4 py-4">
                                                    ...
                                                    <td className="px-4 py-4">
                                                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                                                            ...
                                                            {earning.final_payment?.method === 'online' ? t('payment.online') : t('payment.cash')}
                                                        </span>
                                                    </td>
                                                    <td className="px-4 py-4">
                    ...
                    <div className="max-w-2xl mx-auto">
                        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
                            <div className="flex items-center space-x-3 mb-6">
                                ...
                                <div>
                            <h2 className="text-2xl font-bold text-neutral-900">{t('settings.changePassword')}</h2>
                            <p className="text-sm text-neutral-600">{t('settings.secureAccount')}</p>
                                </div>
                            </div>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                            <p className="text-sm font-medium text-amber-800">{t('settings.emailVerificationRequired')}</p>
                                            <p className="text-xs text-amber-700 mt-1">{t('settings.otpSentNote')}</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        {isRequestingOTP ? (
                                            <>
                                                <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
                                                        <span>{t('settings.sendingOtp')}</span>
                                            </>
                                        ) : (
                                            <>
                                                <Mail className="w-5 h-5" />
                                                <span>{t('settings.sendVerificationOtp')}</span>
                                            </>
                                        )}
                                    </button>
                                </div>
                            ...
                            <h3 className="text-lg font-bold text-neutral-900 mb-2">{t('settings.verifyYourEmail')}</h3>
                            <p className="text-sm text-neutral-600 mb-4">
                                {t('settings.otpSentTo', { email: user?.email })}
                            </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder={t('form.enterOtpPlaceholder')}
                                            maxLength={6}
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3">
                                        ...
                                        >
                                            {isVerifyingOTP ? (
                                                <>
                                                    <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
                                                    <span>{t('settings.verifying')}</span>
                                                </>
                                            ) : (
                                                <>
                                                    <Shield className="w-5 h-5" />
                                                    <span>{t('settings.verifyChangePassword')}</span>
                                                </>
                                            )}
                                        </button>
                                        <button
                                    ...
                                    <div className="text-center pt-2">
                                        ...
                                        >
                                            {isResendingOTP ? (
                                                ...
                                                t('settings.resendOtpIn', { count: resendCooldown })
                                            ) : (
