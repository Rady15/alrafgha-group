...
const AboutUsPage = () => {
  ...
  const developers = [
    ...
    {
      name: 'Joy Bhowmik',
      role: t('about.dev.3.role'),
      github: 'joybhowmik_07',
      linkedin: 'joybhowmik_07',
      email: 'joybhowmik07@alrafgha-group.com',
      avatar: 'https://avatars.githubusercontent.com/u/231863193?v=4'
    }
  ];
  ...
  const values = [
    {
      ...
      title: t('about.value.0.title'),
      description: t('about.value.0.description')
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: t('about.value.1.description')
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: t('about.value.2.description')
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: t('about.value.3.description')
    }
  ];
  ...
  const forWhom = [
    {
      ...
      features: [t('about.for.0.feature.0'), t('about.for.0.feature.1'), t('about.for.0.feature.2'), t('about.for.0.feature.3'), t('about.for.0.feature.4')],
      icon: (
    ...
    },
    {
      ...
      features: [t('about.for.1.feature.0'), t('about.for.1.feature.1'), t('about.for.1.feature.2'), t('about.for.1.feature.3'), t('about.for.1.feature.4')],
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      features: [t('about.for.2.feature.0'), t('about.for.2.feature.1'), t('about.for.2.feature.2'), t('about.for.2.feature.3'), t('about.for.2.feature.4')],
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-neutral-50 via-primary-50 to-secondary-50">
      ...
      <section className="relative pt-20 pb-16 md:pt-28 md:pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              {t('about.heroTitle')} <span className="text-transparent bg-clip-text bg-linear-to-r from-primary-500 to-secondary-600">Alrafgha Group</span>
            </h1>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-neutral-900 mb-4">{t('about.developersTitle')} <span className='text-red-500'>:</span></h2>
            <p className="text-neutral-600 max-w-2xl mx-auto">{t('about.developersSubtitle')}</p>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
