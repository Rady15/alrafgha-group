...
const sendEmail = async (options) => {
    ...
    try {
        ...
        const mailOptions = {
            from: process.env.EMAIL_FROM || 'Alrafgha Group <noreply@alrafgha-group.com>',
            to: options.email,
...
const sendOTPEmail = async (email, otp, name) => {
    const subject = 'Verify Your Email - Alrafgha Group';
                    ...
                    <table role="presentation" style="width: 100%; max-width: 500px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <tr>
                            <td style="padding: 40px 40px 20px; text-align: center; background: linear-gradient(135deg, #6366f1 0%, #ec4899 100%); border-radius: 16px 16px 0 0;">
                                <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 700;">Alrafgha Group</h1>
                        ...
                        <tr>
                            <td style="padding: 40px;">
                                ...
                                <p style="margin: 0 0 30px; color: #4b5563; font-size: 16px; line-height: 1.6;">Thank you for registering with Alrafgha Group! Please use the following OTP to verify your email address:</p>
                        ...
                        <tr>
                            <td style="padding: 20px 40px 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                                <p style="margin: 0; color: #9ca3af; font-size: 12px;">&copy; ${new Date().getFullYear()} Alrafgha Group. All rights reserved.</p>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    const text = `Hi ${name},\n\nThank you for registering with Alrafgha Group!\n\nYour OTP code is: ${otp}\n\nThis OTP is valid for 10 minutes.\n\nIf you didn't create an account, please ignore this email.\n\nBest regards,\nAlrafgha Group Team`;
...
const sendPasswordResetEmail = async (email, resetURL, name) => {
    const subject = 'Reset Your Password - Alrafgha Group';
...
const sendPasswordChangeOTPEmail = async (email, otp, name) => {
    const subject = 'Password Change Verification - Alrafgha Group';
...
const sendPickupConfirmationEmail = async (email, bookingData) => {
    ...
    const subject = `🚗 Vehicle Pickup Confirmed - ${billId} | Alrafgha Group`;
                    ...
                    <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                                ...
                                <div style="background: #fef3c7; border-radius: 12px; padding: 20px; margin-bottom: 25px;">
                                    ...
                                    <table style="width: 100%; border-collapse: collapse;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 8px 0; color: #1f2937; font-size: 14px; font-weight: 600; text-align: right;">SAR ${pricePerKm}</td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Rate per Hour</td>
                                            <td style="padding: 8px 0; color: #1f2937; font-size: 14px; font-weight: 600; text-align: right;">SAR ${pricePerHour}</td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <tr>
                            <td style="padding: 30px 40px; text-align: center; border-top: 1px solid #e5e7eb; background: #f9fafb; border-radius: 0 0 16px 16px;">
                                ...
                                <p style="margin: 0 0 15px; color: #059669; font-size: 14px; font-weight: 600;">support@alrafgha-group.com</p>
                                <p style="margin: 0; color: #9ca3af; font-size: 12px;">&copy; ${new Date().getFullYear()} Alrafgha Group. All rights reserved.</p>
                            </td>
                        </tr>
                    </table>
...
- Rate per KM: SAR ${pricePerKm}
- Rate per Hour: SAR ${pricePerHour}
...
Need help? Contact us at support@alrafgha-group.com
...
const sendReturnConfirmationEmail = async (email, bookingData) => {
    ...
    const subject = `🎉 Vehicle Returned Successfully - ${billId} | Alrafgha Group`;
                    ...
                    <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <tr>
                            <td style="padding: 30px 40px 20px; text-align: center;">
                                ...
                                <p style="margin: 0; color: #6b7280; font-size: 16px;">Thank you for choosing Alrafgha Group!</p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 30px 40px; text-align: center; border-top: 1px solid #e5e7eb; background: #f9fafb; border-radius: 0 0 16px 16px;">
                                <p style="margin: 0 0 10px; color: #6b7280; font-size: 14px;">Need help? Contact us at</p>
                                <p style="margin: 0 0 15px; color: #6366f1; font-size: 14px; font-weight: 600;">support@alrafgha-group.com</p>
                                <p style="margin: 0; color: #9ca3af; font-size: 12px;">&copy; ${new Date().getFullYear()} Alrafgha Group. All rights reserved.</p>
                            </td>
                        </tr>
                    </table>
...
Thank you for choosing Alrafgha Group!
...
const sendVendorVerificationEmail = async (email, vendorData) => {
    ...
    const subject = `🎉 Vendor Account Verified - Welcome to Alrafgha Group!`;
                            ...
                            <td style="padding: 20px 40px;">
                                ...
                                <div style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-radius: 12px; padding: 25px; margin-bottom: 25px; border: 2px solid #10b981;">
                                    ...
                                    <ul style="margin: 0; padding-left: 20px; color: #065f46; font-size: 14px; line-height: 1.8;">
                                        ...
                                        <li><strong>Grow your business</strong> with Alrafgha Group's customer base</li>
                                    </ul>
                                </div>
...
- Grow your business with Alrafgha Group's customer base
...
const sendVehicleApprovalEmail = async (email, vehicleData) => {
    ...
    const subject = `✅ Vehicle Approved - ${vehicleBrand} ${vehicleName} | Alrafgha Group`;
                    ...
                    <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <tr>
                            <td style="padding: 30px 40px 20px; text-align: center;">
                                ...
                                <p style="margin: 0; color: #6b7280; font-size: 16px;">Your vehicle is now listed on Alrafgha Group</p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 20px 40px;">
                                <p style="margin: 0 0 20px; color: #4b5563; font-size: 16px; line-height: 1.6;">Hi <strong>${vendorName}</strong>,</p>
                                <p style="margin: 0 0 25px; color: #4b5563; font-size: 16px; line-height: 1.6;">Great news! Your vehicle has been reviewed and approved by our admin team. It is now live on the Alrafgha Group platform and available for customers to book.</p>
...
Great news! Your vehicle has been reviewed and approved by our admin team. It is now live on the Alrafgha Group platform and available for customers to book.
...
const sendCancellationEmail = async (email, bookingData) => {
    ...
    const subject = `🚫 Booking Cancelled - ${billId !== 'N/A' ? billId : 'Booking Request'} | Alrafgha Group`;
                ...
                <td style="padding: 40px 0; text-align: center;">
                    <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <tr>
                            <td style="padding: 30px 40px; text-align: center; border-top: 1px solid #e5e7eb; background: #f9fafb; border-radius: 0 0 16px 16px;">
                                <p style="margin: 0 0 10px; color: #6b7280; font-size: 14px;">Need help? Contact us at</p>
                                <p style="margin: 0 0 15px; color: #dc2626; font-size: 14px; font-weight: 600;">support@alrafgha-group.com</p>
                                <p style="margin: 0; color: #9ca3af; font-size: 12px;">&copy; ${new Date().getFullYear()} Alrafgha Group. All rights reserved.</p>
                            </td>
                        </tr>
                    </table>
